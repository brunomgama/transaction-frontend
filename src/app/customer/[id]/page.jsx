                    ...
                    {isSuccess ? (
                        <div className="flex items-center justify-center">
                            <form
                                ...
                                <label htmlFor="name" className="block mt-2 text-sm font-medium text-light dark:text-dark">Customer Name</label>
                                <input
                                    ...
                                    id="name"
                                />
                                <label htmlFor="surname" className="block mt-2 text-sm font-medium text-light dark:text-dark">Customer Surname</label>
                                <input
                        ...
                        <div>
                            <p>Failed to load customer data either it does not exist or there was a server error.</p>
                        </div>
                    )}
                </>
            )}
